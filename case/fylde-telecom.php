  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-12 center">
        <div class="heroMainImage" > <img src="../img/studies/fylde/fylde-telecom.png" class="img-responsive"  alt=""/> </div>
...
<section class="content-section">
  <div class="container">
    <div class="row">
      <div class=" col-lg-12" > <img src="../img/studies/fylde/concept.png" class="img-responsive"  alt=""/></div>
    </div>
  </div>
</section>
<section class="content-section">
  <div class="container">
    <div class="row">
      <div class=" col-lg-12">
       <h2>The Concept</h2>
      <p class="largeText">Fylde Telecom’s main goal was to allow online repair tracking on any device using a clear and straight forward interface. The admin area needed to be straight forward to use and quick to load. </p>
...
<section class="content-section">
  <div class="container">
    <div class="row">
      <div class="col-lg-6"> <img src="../img/work/portfolio/fylde-port.jpg" class="img-responsive"  alt=""/> </div>
      <div class="col-lg-6"> <img src="../img/work/portfolio/fylde-mobile.jpg" class="img-responsive" alt="" /> </div>
    </div>
    
        <div class="row">
      <div class="col-lg-6"> <img src="../img/work/portfolio/fylde-wire.jpg" class="img-responsive"  alt=""/> </div>
      <div class="col-lg-6"> <img src="../img/work/portfolio/fylde-admin.jpg" class="img-responsive" alt="" /> </div>
    </div>
