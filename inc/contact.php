    ...
    <div class="row lightGallery work-gallery padding">
      <div class="col-lg-6 col-md-6 col-xs-12">
        <form action="sendmail.php" method="post" id="sendmail">
          <h3 style="color: #FFF; left: 0px; top: 0px; bottom: 4px; position: relative;">Have a Project? </h3>
          <p>Please fill in our quick form and one of our represenatives will contact you. </p>
